...
let commandName, commandArgs, version = 'CLI version ' + pkg.version;

try {
  const mainPkg = require(cwd + '/node_modules/justreq/package.json');
  version += '\nLocal version ' + mainPkg.version;
} catch (err) {}
...
program
  ...
  .option('-c, --clean', 'Clean caches and start JR.')
